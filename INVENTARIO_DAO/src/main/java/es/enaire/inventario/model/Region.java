...
/**
 * Entidad que representa la informacion almacenada en la tabla REGIONES.
 *
 */
@Entity
@Table(name="REGIONES")
@DTOTarget(claseImplementacionDTO="es.enaire.inventario.dtos.RegionDTO")
public class Region implements Serializable, IBaseEntity<RegionDTO> {
	 ...
	 */
	@Id
	@GeneratedValue(generator = "SEQ_REGIONES", strategy = GenerationType.SEQUENCE)
