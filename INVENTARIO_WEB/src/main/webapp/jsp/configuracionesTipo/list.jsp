...
<div class="listado">
	<table class="listado-tabla listado-tabla-2-columnas" data-columnas="5">
		<thead>
			<s:actionerror/>
			...
			<tr class="filtrado">
				<s:if test="filtro != null && filtro.camposFiltro!= null">
					<th colspan="14">
						<s:url var="configuracionTipoUrl" namespace="/configuracionesTipo" action="list"/>
						<b><s:property value="getText('global.filtrado')"/></b> <s:property value="filtro.camposFiltro"/> <s:a href="%{configuracionTipoUrl}"><s:property value="getText('global.quitarFiltro')"/></s:a>
					</th>
				</s:if>
			</tr>
			</th>
...
<%-- 				<th scope="col"><s:property value="getText('global.name')"/></th> --%>
				<th scope="col"><s:property value="getText('familiaInstalacion')"/></th>
				<th scope="col"><s:property value="getText('global.marca')"/></th>
				<th scope="col"><s:property value="getText('global.modelo')"/></th>
	...
	<s:form name="changeStatusForm" theme="simple" id="formularioAccionesCTC">
		...
		<div class="listado-opciones-popup">
			...
			<div class="listado-opcion" id="menu_eliminar" style="display:none">
					<button type="button" class="formulario-boton" onclick="confirmarAccion('formularioAccionesCTC', 'Vas a dar de baja esta configuración de Tipo Activa. ¿Desea continuar?', 'delete');"><s:property value="getText('global.delete')" /></button>
			</div>
			<div class="listado-opcion" id="menu_reactivar" style="display:none">
					<button type="button" class="formulario-boton" onclick="confirmarAccion('formularioAccionesCTC', 'Vas a reactivar esta configuración de Tipo Activa. ¿Desea continuar?', 'reactivar');"><s:property value="getText('global.reactivar')" /></button>
			</div>
...
<div class="popup" id="idFamiliasInstalacionPopup" style="display: none;"></div>
