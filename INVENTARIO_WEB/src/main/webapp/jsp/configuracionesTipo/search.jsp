	...
	<div class="formulario-contenido form-view">
		...
		<div class="form-row">
			<label class="col-mid">
				...
				<s:textfield maxlength="30" name="filtro.tipoInstalacion.marca" key="global.marca"/>
			</label>
			<label class="col-mid">
				<span class="etiqueta"><s:property value="getText('global.modelo')" /></span>
				<s:textfield maxlength="30" name="filtro.tipoInstalacion.modelo" key="global.modelo"/>
			</label>
		</div>
		...
		<div class="form-row">
			<label class="col-max">
				...
				<s:textfield maxlength="250" name="filtro.observaciones" key="global.name"/>
			</label>
		</div>
		...
		<div class="form-row">
			<label class="col-max date">
				<label class="col-mid date">
					<span class="etiqueta"><s:property value="getText('global.fechaAlta.desde')"/></span>
		...
		<div class="form-row">
			<label class="col-max date" id="fechaBajaBusqueda" style="display: none;">
				<span class="etiqueta"><s:property value="getText('global.fechaBaja.desde')"/></span>
				<span class="dato col-mid">
					<div class="form-row">
						<div class="form-column col-45">
							<div class="form-row">
