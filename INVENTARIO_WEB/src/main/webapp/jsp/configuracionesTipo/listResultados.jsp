...
<%-- 			<td title="<s:property value="getText('global.name')"/>"><s:property value="nombre"/></td> --%>
			<td title="<s:property value="getText('familiasInstalaciones')"/>"><s:property value="tipoInstalacion.familiaInstalacion.nombre"/></td>
			<td title="<s:property value="getText('global.marca')"/>"><s:property value="tipoInstalacion.marca"/></td>
			<td title="<s:property value="getText('global.modelo')"/>"><s:property value="tipoInstalacion.modelo"/></td>			
