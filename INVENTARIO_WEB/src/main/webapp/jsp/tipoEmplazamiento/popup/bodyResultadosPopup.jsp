...
<tbody id="itemsPopup">
	<s:iterator var="tipoEmplazamiento" value="popupList" status="TipoEmplazamientoStatus">
		<tr ondblclick="elementoSeleccionadoPopup('<s:property value="id"/>');" 
			class="<s:if test="#TipoEmplazamientoStatus.odd == true ">odd</s:if><s:else>even</s:else>" id="rowId_<s:property value="id"/>">
