...
<div class="edicion edicion-formulario">
	...
	<s:hidden name="elemento.activo"/>
		<div class="formulario-contenido form-view" id="formulario-region">
			...
			<h2 class="titulo-seccion"><s:property value="getText('tipoEmplazamiento')"/></h2>
			...
			<div class="form-row">
				<label class="col-mid">
					...
					<span class="dato"><textarea type="text"  value="" maxlength="200" name="descripcion"><s:property value="descripcion"/></textarea></span>
				</label>
			</div>
