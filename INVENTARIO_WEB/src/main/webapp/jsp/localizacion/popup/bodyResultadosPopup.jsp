...
<tbody id="itemsPopup">
	<s:iterator var="localizacion" value="popupList" status="LocalizacionStatus">
		<tr ondblclick="elementoSeleccionadoPopup('<s:property value="id"/>');" 
			class="<s:if test="#LocalizacionStatus.odd == true ">odd</s:if><s:else>even</s:else>" id="rowId_<s:property value="id"/>">
