	...
	<div class="formulario-contenido form-view">
		...
		<div class="form-row">
			<label class="col-mid">
				...
				<s:textfield maxlength="500" name="filtro.region.nombre" key="global.region"/>
			</label>
		</div>
		<div class="form-row">
			<label class="col-mid">
				<span class="etiqueta"><s:property value="getText('localizacion')" /></span>
				<s:textfield maxlength="500" name="filtro.localizacion.nombre" key="global.name"/>
			</label>
		</div>
		<div class="form-row">
			<label class="col-mid">
				<span class="etiqueta"><s:property value="getText('emplazamiento')" /></span>
				<s:textfield maxlength="500" name="filtro.emplazamiento.nombre" key="global.name"/>
			</label>
		</div>
		<div class="form-row">
			<label class="col-mid">
