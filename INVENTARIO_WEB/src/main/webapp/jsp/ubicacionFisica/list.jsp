	...
	<table class="listado-tabla listado-tabla-2-columnas" data-columnas="4">
		<thead>
			...
			<tr class="filtrado">
				<s:if test="filtro != null && filtro.camposFiltro!= null">
					<th colspan="14">
						...
						<b><s:property value="getText('global.filtrado')"/></b> <s:property value="filtro.camposFiltro"/> <s:a href="%{ubicacionFisicaUrl}"><s:property value="getText('global.quitarFiltro')"/></s:a>
					</th>
				</s:if>
			</tr>
			</th>
			<tr data-id="1">
				...
				<th scope="col"><s:property value="getText('localizacion')"/></th>
				<th scope="col"><s:property value="getText('emplazamiento')"/></th>								
