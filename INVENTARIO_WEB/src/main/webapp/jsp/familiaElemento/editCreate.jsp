...
<div class="edicion edicion-formulario">
	...
	<s:hidden name="elemento.fechaAlta"/>
			<div class="formulario-contenido" id="formulario-region">
				<fieldset>
					<h2 class="titulo-seccion"><s:property value="getText('familiaElemento')"/></h2>
					<div class="form-row">
						...
						<label class="col-max obligatorio">
							...
							<span class="dato"><input type="text" required="true"  value="${descripcion}"  maxlength="300" name="descripcion" /></span>
						</label>
					</div>
					<div class="form-row">		
						<label class="col-max">
