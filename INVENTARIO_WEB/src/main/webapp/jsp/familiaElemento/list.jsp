...
<div class="listado">
	<table class="listado-tabla listado-tabla-2-columnas" data-columnas="3">
		<thead>
			<s:actionerror/>
			...
			<tr class="filtrado">
				<s:if test="filtro != null && filtro.camposFiltro!= null">
					<th colspan="14">
						...
						<b><s:property value="getText('global.filtrado')"/></b> <s:property value="filtro.camposFiltro"/> <s:a href="%{familiaElementoUrl}"><s:property value="getText('global.quitarFiltro')"/></s:a>
					</th>
				</s:if>
			</tr>
			</th>
	...
	<s:form name="changeStatusForm" theme="simple" id="formularioAccionesRegion">
		...
		<div class="listado-opciones-popup">
			...
			<div class="listado-opcion" id="menu_eliminar" style="display:none">
					<button type="button" class="formulario-boton" onclick="confirmarAccion('formularioAccionesRegion', 'Vas a dar de baja una Familia de Elementos. ¿Desea continuar?', 'delete');"><s:property value="getText('global.delete')" /></button>
			</div>
			<div class="listado-opcion" id="menu_reactivar" style="display:none">
					<button type="button" class="formulario-boton" onclick="confirmarAccion('formularioAccionesRegion', 'Vas a reactivar una Familia de Elementos. ¿Desea continuar?', 'reactivar');"><s:property value="getText('global.reactivar')" /></button>
			</div>
