...
<tbody id="itemsPopup">
	<s:iterator var="sector" value="popupList" status="sectorStatus">
		<tr ondblclick="elementoSeleccionadoPopup('<s:property value="id"/>');" 
			class="<s:if test="#sectorStatus.odd == true ">odd</s:if><s:else>even</s:else>" id="rowId_<s:property value="id"/>">
