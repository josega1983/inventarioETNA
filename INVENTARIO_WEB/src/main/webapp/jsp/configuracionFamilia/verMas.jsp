...
<div class="visualizacion-formulario">
	<fieldset>
		...
		<s:push value="elemento">
			<h2 class="titulo-seccion"><s:property value="getText('configuracionesFamilias')"/></h2>
			<div class="form-row">
				<div class="form-column col-70">
					<div class="form-row">
						<label class="col-mid">
							<span class="etiqueta"><s:property value="getText('familiaInstalacion')"/></span>
							<span class="dato"><s:property  value="familiaInstalacion.nombre"/></span>
						</label>
					</div>
					<div class="form-row">
						<label class="col-mid">
							<span class="etiqueta"><s:property value="getText('familiasInstalaciones.area')"/></span>
							<span class="dato"><s:property  value="familiaInstalacion.area"/></span>
						</label>
					</div>
					<div class="form-row">
						<label class="col-max">
			...
			<fieldset>
				<div class="plegable">
					<h2 class="plegable-titulo"><s:property value="getText('configuracionesFamilias')"/> Arbol</h2>
