	...
	<s:push value="elemento">
		...
		<div class="form-row">
			<div class="form-column col-40">
				<div class="form-row">
					<label class="col-max">
						<span class="etiqueta"><s:property value="getText('familiasInstalaciones')"/></span>
			...
			<div class="form-column col-60">
				<div class="form-row">
					<label class="col-max">
						...
						<span class="dato"><s:property  value="marca"/></span>
					</label>
				</div>
				<div class="form-row">
					<label class="col-max">
						<span class="etiqueta"><s:property value="getText('global.modelo')"/></span>
						<span class="dato"><s:property  value="modelo"/></span>
					</label>
				</div>
				<div class="form-row">
					<label class="col-max">
