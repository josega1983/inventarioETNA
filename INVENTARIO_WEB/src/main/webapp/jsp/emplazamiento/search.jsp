...
<s:form cssClass="buscador-formulario" action="search" theme="simple" id="formularioBusqueda">
	...
	<div class="formulario-contenido form-view">
		<div class="form-row">
			...
			<label class="col-max">
				<span class="etiqueta"><s:property value="getText('tipoEmplazamiento')" /></span>
				<s:select label="tipoEmplazamiento"
					headerKey="" headerValue="%{getText('global.select_list')}"
					list="tiposEmplazamientosList"
					name="filtro.tipoEmplazamiento.id" listValue="nombre" listKey="id"/>
			</label>
		</div>
		<div class="form-row">
			<label class="col-mid">
