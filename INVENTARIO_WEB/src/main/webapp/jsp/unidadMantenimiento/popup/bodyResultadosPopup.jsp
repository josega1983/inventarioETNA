...
<tbody id="itemsPopup">
	<s:iterator var="unidadMantenimiento" value="popupList" status="unidadMantenimientoStatus">
		<tr ondblclick="elementoSeleccionadoPopup('<s:property value="id"/>');" 
			class="<s:if test="#unidadMantenimientoStatus.odd == true ">odd</s:if><s:else>even</s:else>" id="rowId_<s:property value="id"/>">
