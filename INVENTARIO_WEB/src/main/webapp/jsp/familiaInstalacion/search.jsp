...
<s:form cssClass="buscador-formulario" action="search" theme="simple" id="formularioBusqueda" name="formularioBusqueda">
	...
	<div class="formulario-contenido form-view">
		...
		<div class="form-row">
			...
			<label class="col-mid">
				<s:property value="getText('familiasInstalaciones.area')" />
				<s:textfield maxlength="250" cssClass="col-30" name="filtro.area" key="global.area"/>
			</label>
		</div>
		...
		<div class="form-row">
			<label class="col-max date" id="fechaBajaBusqueda">
