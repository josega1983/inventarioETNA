...
public class OperacionesValoresParametroFuncional {

	/**
	 * DAO de valores Parametro Funcionales
	 */
	@Autowired
	private ValoresParametroFuncionalDAO<ValoresParametroFuncionalDTO> valoresParametroFuncionalDAO;
	/**
	...
	private RespuestaDTO validateInfo(EntradaDTO entrada) {
		...
		if(!(entrada.getObjetoEntrada() instanceof ValoresParametroFuncionalDTO)){
			respuesta.setCodigoRespuesta(CodigosRespuestaConstants.ERROR_TIPO_ENTRADA_NO_ESPERADA);
			return respuesta;
		}

		if(entrada.getObjetoEntrada() instanceof ValoresParametroFuncionalDTO) {
			ValoresParametroFuncionalDTO valoresParametroFuncional =(ValoresParametroFuncionalDTO) entrada.getObjetoEntrada();
			if (valoresParametroFuncional.getId() == null) {
	...
	public RespuestaDTO info(EntradaDTO entrada) throws Exception {
		...
		if (respuesta.getCodigoRespuesta().equals(CodigosRespuestaConstants.RESPUESTA_OK)) {
			...
			ValoresParametroFuncionalDTO valoresParametroFuncionalRespuesta = null;
			if(entrada.getObjetoEntrada() instanceof ValoresParametroFuncionalDTO) {
				valoresParametroFuncionalRespuesta = valoresParametroFuncionalDAO.listById(((ValoresParametroFuncionalDTO)entrada.getObjetoEntrada()).getId());
			}

			if(valoresParametroFuncionalRespuesta != null) {
				Object[] objetoRespuesta={valoresParametroFuncionalRespuesta};
	...
	public RespuestaDTO list(EntradaDTO entrada) throws Exception {
		...
		if (respuesta.getCodigoRespuesta().equals(CodigosRespuestaConstants.RESPUESTA_OK)) {
			List<ValoresParametroFuncionalDTO> valoresParametroFuncionalRespuesta = valoresParametroFuncionalDAO.list(entrada.getPaginaActual(), entrada.getTamanioPagina());
			Object[] objetoRespuesta = valoresParametroFuncionalRespuesta.toArray();
			respuesta.setObjetoRespuesta(objetoRespuesta);
		}
		return respuesta;
	}
...
//		ValoresParametroFuncionalDTO valoresParametroFuncional = (ValoresParametroFuncionalDTO) entrada.getObjetoEntrada();
//		if(valoresParametroFuncional.getNombre() == null ||valoresParametroFuncional.getNombre().isEmpty() ){
//			respuesta.setCodigoRespuesta(CodigosRespuestaConstants.ERROR_NOMBRE_NO_INFORMADO);
//			return respuesta;
//		}
//		FiltroValoresParametroFuncional filtro = new FiltroValoresParametroFuncional();
//		filtro.setNombre(valoresParametroFuncional.getNombre());
//		if(valoresParametroFuncional.getId() != null){//es una actualizacion y hay que excluirlo
//			filtro.setIdExcluir(valoresParametroFuncional.getId());
//		}
//		List<ValoresParametroFuncionalDTO> valoresParametroFuncionalList = valoresParametroFuncionalDAO.search(filtro, 0L, 1L);
//				if(valoresParametroFuncionalList !=null && valoresParametroFuncionalList.size() >0){
...
//				}
	...
	public RespuestaDTO edit(EntradaDTO entrada) throws Exception {
		...
		if (respuesta.getCodigoRespuesta().equals(CodigosRespuestaConstants.RESPUESTA_OK)) {
			ValoresParametroFuncionalDTO valoresParametroFuncionalEntrada = (ValoresParametroFuncionalDTO) entrada.getObjetoEntrada();
			ValoresParametroFuncionalDTO valoresParametroFuncionalRespuesta = valoresParametroFuncionalDAO.saveOrUpdate(valoresParametroFuncionalEntrada);
			Object[] objetoRespuesta={valoresParametroFuncionalRespuesta};
			respuesta.setObjetoRespuesta(objetoRespuesta);
		}
		return respuesta;
	...
	public RespuestaDTO reactivar(EntradaDTO entrada) throws Exception {
		...
		if (respuesta.getCodigoRespuesta().equals(CodigosRespuestaConstants.RESPUESTA_OK)) {
			ValoresParametroFuncionalDTO valoresParametroFuncionalEntrada = (ValoresParametroFuncionalDTO) entrada.getObjetoEntrada();
			ValoresParametroFuncionalDTO valoresParametroFuncionalRespuesta = valoresParametroFuncionalDAO.reactivar(valoresParametroFuncionalEntrada.getId());
			Object[] objetoRespuesta={valoresParametroFuncionalRespuesta};
			respuesta.setObjetoRespuesta(objetoRespuesta);
		}
		return respuesta;
	...
	public RespuestaDTO delete(EntradaDTO entrada) throws Exception {
		...
		if (respuesta.getCodigoRespuesta().equals(CodigosRespuestaConstants.RESPUESTA_OK)) {
			ValoresParametroFuncionalDTO valoresParametroFuncionalEntrada = (ValoresParametroFuncionalDTO) entrada.getObjetoEntrada();
			valoresParametroFuncionalDAO.delete(valoresParametroFuncionalEntrada.getId());
		}
		return respuesta;
	}
	/**
	...
	private RespuestaDTO validateSearch(EntradaDTO entrada) {
		...
		if(!(entrada.getObjetoEntrada() instanceof FiltroValoresParametroFuncional)) {
			respuesta.setCodigoRespuesta(CodigosRespuestaConstants.ERROR_TIPO_ENTRADA_NO_ESPERADA);
			return respuesta;
		}
	...
	public RespuestaDTO search(EntradaDTO entrada) throws Exception {
		...
		if (respuesta.getCodigoRespuesta().equals(CodigosRespuestaConstants.RESPUESTA_OK)) {
			List<ValoresParametroFuncionalDTO> regionListRespuesta = valoresParametroFuncionalDAO.search( (FiltroValoresParametroFuncional) entrada.getObjetoEntrada(), entrada.getTamanioPagina(), entrada.getPaginaActual());
	...
	private RespuestaDTO validateChangeStatus(EntradaDTO entrada) {
		...
		ValoresParametroFuncionalDTO valoresParametroFuncional = (ValoresParametroFuncionalDTO) entrada.getObjetoEntrada();
		if(!entrada.getAccion().equals(AccionesCatalogosConstans.CREACION) && valoresParametroFuncional.getId()==null){
			respuesta.setCodigoRespuesta(CodigosRespuestaConstants.ERROR_ID_NO_INFORMADO);
			return respuesta;
		}
...
//				valoresParametroFuncionalEntrada.setActivo(AccionesCatalogosConstans.ACTIVO_SI);
//				valoresParametroFuncionalEntrada.setFechaBaja(null);
//			}
//			if(entrada.getAccion().equals(AccionesCatalogosConstans.ELIMINACION)){
//				valoresParametroFuncionalEntrada.setActivo(AccionesCatalogosConstans.ACTIVO_NO);
//				valoresParametroFuncionalEntrada.setFechaBaja(new Date());
//			}
